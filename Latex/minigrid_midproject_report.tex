...
\begin{itemize}
  ...
  \item Initial exploration: $\epsilon_0 = 1.0$, $\epsilon_{min} = 0.05$
...
Figure~\ref{fig:empty_reward} presents the smoothed training reward (success rate) for each algorithm in \envEmpty, using the best hyperparameter configuration per method.

\begin{figure}[H]
\centering
\begin{subfigure}{0.49\textwidth}
  \centering
  \includegraphics[width=\textwidth]{figs/empty_mc_best_reward.png}
  \caption{\mc: training reward vs.\ episodes.}
\end{subfigure}
\hfill
\begin{subfigure}{0.49\textwidth}
  \centering
  \includegraphics[width=\textwidth]{figs/empty_sarsa_best_reward.png}
  \caption{\sarsa: training reward vs.\ episodes.}
\end{subfigure}
...
\begin{subfigure}{0.49\textwidth}
  \centering
  \includegraphics[width=\textwidth]{figs/empty_q_best_reward.png}
  \caption{\qlearn: training reward vs.\ episodes.}
\end{subfigure}

\caption{\envEmpty: smoothed training reward (success rate) under best hyperparameters for each algorithm.}
\label{fig:empty_reward}
\end{figure}

All three algorithms converge to optimal performance.
Q-learning reaches stable success in fewer episodes, followed by SARSA, while Monte Carlo exhibits higher variance and slower convergence.


\subsubsection{Training efficiency (steps per episode)}
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{figs/empty_best_steps_all.png}
\caption{\envEmpty: average steps per episode during training.}
\label{fig:empty_steps}
\end{figure}

\subsubsection{Inference evaluation}
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{figs/infer_empty_avg_steps.png}
\caption{\envEmpty: average steps per episode during inference (greedy policy).}
\label{fig:empty_infer}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{figs/key_best_reward_all.png}
\caption{\envKey: training reward (success rate) vs.\ episodes for \mc, \sarsa, and \qlearn.}
\label{fig:key_reward}
\end{figure}

Compared to \envEmpty, convergence is slower due to the larger state space and delayed rewards.
Q-learning shows the strongest advantage in this environment.

\subsubsection{Training efficiency (steps per episode)}
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{figs/key_best_steps_all.png}
\caption{\envKey: average steps per episode during training.}
\label{fig:key_steps}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.85\textwidth]{figs/infer_key_avg_steps.png}
\caption{\envKey: average steps per episode during inference (greedy policy).}
\label{fig:key_infer}
\end{figure}
...
\midrule
\envEmpty & \mc     & 0.1 & 0.9  & 0.999  & \texttt{...} \\
\envEmpty & \sarsa  & 0.2 & 0.9  & 0.999  & \texttt{...} \\
\envEmpty & \qlearn & 0.1 & 0.9  & 0.999  & \texttt{...} \\
\addlinespace
